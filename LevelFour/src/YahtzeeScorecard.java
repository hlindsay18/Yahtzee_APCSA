public class YahtzeeScorecard
{
	...
	public boolean markSmallStraight(int die1, int die2, int die3, int die4, int die5)
	{
		if (smStraight != -1) {
			...
			YahtzeeSortDice die = new YahtzeeSortDice(die1, die2, die3, die4, die5);
			if (die.getFirst() +1 == die.getSecond() && (((die.getSecond() + 1 == die.getThird()) && (die.getThird() +1 == die.getFourth() || die.getThird() == die.getFifth())) || die.getSecond() + 1 == die.getFourth() && die.getFourth() + 1 == die.getFifth())){
				smStraight = 30;
			}
	...
	public boolean markLargeStraight(int die1, int die2, int die3, int die4, int die5)
	{
		if (lgStraight != -1) {
			...
			if (die.getFirst() + 1 == die.getSecond() && die.getSecond() +1 == die.getThird() && die.getThird()+1 == die.getFourth() && die.getFourth()+1 == die.getFirst()){
				lgStraight = 40;
			}
			else {
				lgStraight = 0;
